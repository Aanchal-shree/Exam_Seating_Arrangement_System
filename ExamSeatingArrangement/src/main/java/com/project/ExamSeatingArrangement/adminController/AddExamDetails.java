...
import com.project.ExamSeatingArrangement.services.ExamService;
@Controller
...
public class AddExamDetails extends HttpServlet {
	...
	@GetMapping(value ="")
	public String addExams(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ExamService exam1 = new ExamService();
		examService.addExam(sem1);
		...
		ExamService exam2= new ExamService();
		examService.addExam(sem2);
		...
		ExamService exam3=new ExamService();
		examService.addExam(sem3);
		...
		ExamService exam4=new ExamService();
		examService.addExam(sem4);
		...
		ExamService exam5=new ExamService();
		examService.addExam(sem5);
		...
		ExamService exam6=new ExamService();
		examService.addExam(sem6);
		...
		ExamService exam7=new ExamService();
		examService.addExam(sem7);
		...
		ExamService exam8=new ExamService();
		examService.addExam(sem8);
